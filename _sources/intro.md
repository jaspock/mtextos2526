...
Actividades previas
-------------------
- **Antes de la clase del 14/05/2026:** lee el [T2. Aplicaciones específicas y Benchmacks](https://jaspock.github.io/mtextos2526/bloque3_t2_subaplicaciones-benchmarks.html ) y [T2.1. Caso de estudio Análisis de Sentimientos](https://jaspock.github.io/mtextos2526/bloque3_t2.1_analisis_sentimientos.html; a continuación, contesta estos tests [test-t2.0](https://forms.gle/DfCwMt215u7EavUy5).
 - [test-t2.1](https://forms.gle/kNBzXnmiYf6MuZr87) (plazo límite: 23:59 horas del 13/05/2026). Accede al test con tu cuenta de `gcloud.ua.es`. 
