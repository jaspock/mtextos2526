...
```{admonition} Nota
:class: note
Lee con atención la práctica 1.2 del bloque 3. Realiza los ejercicios y una entrega unificada (práctica 1.1 y 1.2), la cual se anunciará en la introducción de la asignatura y a través del uaCloud.
