...
Actividades previas
-------------------
- **Antes de la clase del 21/05/2026:** lee el [Tema 3](https://jaspock.github.io/mtextos2526/bloque3_t3.1_metricas.html) y [Tema 4](https://jaspock.github.io/mtextos2526/bloque3_t4_centralizacion.html) del BLOQUE APLICACIONES; a continuación, contesta estos tests: [test-t3.0](https://forms.gle/Cxt6K41tyoNh19nPA) y [test-t4.0](https://forms.gle/xb87tvyEuaooGvSm7) (plazo límite: 23:59 horas del 20/05/2026). Accede al test con tu cuenta de `gcloud.ua.es`. 
- Antes de la clase del 14/05/2026: lee el [Tema 2 del BLOQUE APLICACIONES](https://jaspock.github.io/mtextos2526/bloque3_t2_subaplicaciones-benchmarks.html) y [Tema 2.1 del BLOQUE APLICACIONES](https://jaspock.github.io/mtextos2526/bloque3_t2.1_analisis_sentimientos.html); a continuación, contesta estos tests: [test-t2.0](https://forms.gle/DfCwMt215u7EavUy5) y [test-t2.1](https://forms.gle/kNBzXnmiYf6MuZr87) (plazo límite: 23:59 horas del 13/05/2026). Accede al test con tu cuenta de `gcloud.ua.es`. 
- Antes de la clase del 07/05/2026: lee el [Tema  1 del BLOQUE APLICACIONES](https://jaspock.github.io/mtextos2526/bloque3_t1_aplicaciones.html); a continuación, contesta este [test-t1.0][testb3.1] (plazo límite: 23:59 horas del 06/05/2026). Accede al test con tu cuenta de `gcloud.ua.es`. 
...
[introduccion]: https://jaspock.github.io/mtextos2526/bloque1.html
...
[tecnicas]: https://jaspock.github.io/mtextos2526/bloque2.html
