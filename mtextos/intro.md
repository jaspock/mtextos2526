...
Actividades previas
-------------------
- **Antes de la clase del 14/05/2026:** lee el [Tema 2 del BLOQUE APLICACIONES](https://jaspock.github.io/mtextos2526/bloque3_t2_subaplicaciones-benchmarks.html) y [Tema 2.1 del BLOQUE APLICACIONES](https://jaspock.github.io/mtextos2526/bloque3_t2.1_analisis_sentimientos.html); a continuación, contesta estos tests: [test-t2.0](https://forms.gle/DfCwMt215u7EavUy5)[test-t2.1](https://forms.gle/kNBzXnmiYf6MuZr87) (plazo límite: 23:59 horas del 13/05/2026). Accede al test con tu cuenta de `gcloud.ua.es`. 
